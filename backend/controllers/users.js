...
usersRouter.get("/:uid", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var auth, uid, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                auth = req.currentUser;
            ...
            case 2:
                user = _a.sent();
                if (user) {
                    return [2 /*return*/, res.json(user.toJSON())];
                }
                else {
            ...
            case 3:
                error_1 = _a.sent();
                console.log("Error retrieving user from /:uid:", error_1);
