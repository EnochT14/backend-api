...
var firebaseServiceAccountPath = path_1.default.join(__dirname, "../firebaseServiceAccount.json");
...
function decodeIDToken(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var header, idToken, decodedToken, error_1;
        var _a;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!(header !== "Bearer null" &&
                        ((_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.startsWith("Bearer ")))) return [3 /*break*/, 4];
                ...
                case 3:
                    error_1 = _b.sent();
                    console.log("Error in decodeIDToken(): ", error_1);
                    return [3 /*break*/, 4];
                case 4:
                    next();
                    return [2 /*return*/];
